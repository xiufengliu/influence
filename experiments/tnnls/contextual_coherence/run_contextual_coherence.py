...
def run_contextual_coherence(datasets, models, influence_methods, clustering_algorithms,
    ...
    logger.info(f"Contextual coherence results saved to {results_file}")
    ...
    if not results_df.empty:
        # Example: Visualize contextual coherence (e.g., entropy)
        plt.figure(figsize=(12, 6))
        sns.boxplot(data=results_df, x="influence_method", y="contextual_coherence_score")
        plt.title("Contextual Coherence by Influence Method")
        plt.savefig(output_dir / "contextual_coherence_boxplot.png")
        plt.close()
